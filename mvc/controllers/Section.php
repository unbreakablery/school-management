...
*/
	...
	public $section_teacher = [];
	public $teacher_string;
	public $teacher_array;
	public function index() {
		...
		if((int)$id) {
			...
			if(isset($fetchClass[$id])) {
				...
				$this->section_teacher =$this->section_m->general_get_order_by_section(array('classesID' => $id));
				foreach($this->section_teacher as $this->section_teacher_object){
					$this->teacher_string=$this->section_teacher_object->teacherID;
					$this->teacher_array = explode(",",$this->teacher_string);
					$this->section_teacher_object->teacherID = $this->teacher_array; 					
				}
				$this->data['sections']=$this->section_teacher;
	...
	public function add() {
		...
		$this->post=$_POST;
		$this->teach = $this->input->post("teacherID[]");
		$this->teach_id = implode(",", (array)$this->teach);
		$this->post["teacherID"] =$this->teach_id;
		$_POST["teacherID"]=$this->post["teacherID"];
		if($_POST) {
			$rules = $this->rules();
	...
	public function edit() {
		...
		if((int)$id && (int)$url) {
			...
			$fetchClass = pluck($this->data['classes'], 'classesID', 'classesID');
			$this->section_teacher =$this->section_m->general_get_single_section(array('sectionID' => $id, 'classesID' => $url));
			$this->teacher_array = explode(",",$this->section_teacher->teacherID);					
			$this->data['section']->teacherID=$this->teacher_array;
			// dd($this->data['section']);
