                ...
                <div class="bg-white mb-15">
                    ...
                    <div class="sidebar-body" id="category-box">
                        <div class="">
                            ...
                            ?>
                                    <div class="form-group ini-dis-flex">
                                        <input id="<?=$posts_categorie->posts_categories?>" class="categories" name="categories[]" value="<?=$posts_categorie->posts_categoriesID?>" type="checkbox"  <?php if(customCompute($send_category)) { if(in_array($posts_categorie->posts_categoriesID, $send_category)) { echo 'checked'; } } ?> >
