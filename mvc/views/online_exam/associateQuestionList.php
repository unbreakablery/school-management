...
if(customCompute($onlineExamQuestions)) {
    foreach ($onlineExamQuestions as $key => $onlineExamQuestion) {
        ...
        $questionLevel = isset($levels[$question->levelID]) ? $levels[$question->levelID] : '';
            ...
            if($question != '') {
                ...
                <div class="clearfix">
                    <div class="question-body">
                        ...
                        <label class="lb-content question-color"><a href="<?=$question_bank_edit?>" target="_blank"><span class="questionNumber<?=$question->questionBankID?>"> <?=$key+1?>  </span>. <?=$question->question .' ( '.$questionLevel->name.' )'?></a></label>
